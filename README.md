## Fin-Mangystau Analyzer
Система для управления личными финансами с автоматическим анализом трат.
## Основной функционал:
- Визуализация баланса через графики.
- Защищенный вход через JWT токены.
- Адаптивный интерфейс (мобильная версия).
## Стек технологий:
